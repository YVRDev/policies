...
You will receive an email from the YVRDev Code of Conduct Working Group acknowledging receipt within 24 hours (and will aim for much quicker than that).
...
* A permanent or temporary ban from some or all YVRDev spaces (events, meetings, mailing lists, IRC, etc.)
...
Finally, the Working Group will make a report on the situation to the YVRDev board. The board may choose to issue a public report of the incident.
